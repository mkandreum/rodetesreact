        ...
        <div className="min-h-screen bg-black text-white font-sans selection:bg-party-500 selection:text-white flex flex-col">
            ...
            <div className="sticky top-0 z-50 bg-black w-full shadow-lg border-b border-gray-800">
                ...
                {promoEnabled && nextEvent && (
                    <div id="next-event-promo-container" className="w-full h-10 flex items-center border-b relative transition-all duration-500 overflow-hidden" style={{ borderColor: promoNeonColor, boxShadow: `0 0 10px ${promoNeonColor}, 0 4px 20px ${promoNeonColor}` }}>
